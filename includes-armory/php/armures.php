...
while(($data3 = mysql_fetch_array($sql3))) {
    ...
    $name_armure = htmlentities($data3['locale_name']);
...
elseif($apierre_3 == '28960') {
	...
	if($abonus_1_v >= '0') { $acolor='color:rgba(200,255,200,1)'; } else { $acolor='color:#e57875'; }
	if($abonus_2_v >= '0') { $acolor2='color:rgba(200,255,200,1)'; } else { $acolor2='color:#e57875'; }
	if($abonus_3_v >= '0') { $acolor3='color:rgba(200,255,200,1)'; } else { $acolor3='color:#e57875'; }
	
	if($an_bonus_1_v >= '0') { $acolor4='color:rgba(200,255,200,1)'; } else { $acolor4='color:#e57875'; }
	if($an_bonus_2_v >= '0') { $acolor5='color:rgba(200,255,200,1)'; } else { $acolor5='color:#e57875'; }
	if($an_bonus_3_v >= '0') { $acolor6='color:rgba(200,255,200,1)'; } else { $acolor6='color:#e57875'; }
	if($an_bonus_4_v >= '0') { $acolor7='color:rgba(200,255,200,1)'; } else { $acolor7='color:#e57875'; }
	if($an_bonus_5_v >= '0') { $acolor8='color:rgba(200,255,200,1)'; } else { $acolor8='color:#e57875'; }
	if($an_bonus_6_v >= '0') { $acolor9='color:rgba(200,255,200,1)'; } else { $acolor9='color:#e57875'; }
	if($an_bonus_7_v >= '0') { $acolor10='color:rgba(200,255,200,1)'; } else { $acolor10='color:#e57875'; }
